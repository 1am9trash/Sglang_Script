...
#  在 container 內執行。需在 decode server 就緒後啟動。
...
# aiter kernel warmup
echo "[prefill] Warming up aiter kernels..."
MAX_JOBS=192 python3 /sgl-workspace/aiter/op_tests/test_rmsnorm2d.py 2>&1 | tail -1
